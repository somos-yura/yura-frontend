        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-4 font-roboto">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-[#2E2E2E] font-montserrat mb-2">MiniWorker Academy</h1>
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-100">
                    ...
                    <div className="mt-6 text-center">
                        ...
                        >
                            ¿No tienes cuenta? <span className="text-electricBlue font-semibold">Regístrate</span>
                        </button>
                    </div>
                </div>
