...
export const SUGGESTED_PROMPTS = [
    ...
    },
    {
        ...
        prompt: "¿Podrías darme más detalles sobre los requisitos específicos del proyecto?",
    },
    {
        icon: Target,
...
export const CHAT_CONFIG = {
    TYPING_DELAY: 1500,
    MAX_INPUT_HEIGHT: 32,
    AI_RESPONSE: "Excelente pregunta. Basándome en mi experiencia en el campo, creo que es fundamental considerar la sostenibilidad a largo plazo y el impacto en la comunidad. ¿Has pensado en cómo tu solución podría adaptarse a diferentes contextos culturales y geográficos?",
} as const
